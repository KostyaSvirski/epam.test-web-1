       ...
       <main>
        <section class="info">
            ...
            <div class="text">
                ...
                <p><fmt:message key="cars.info.power"/> ${car.power}</p>
                <p><fmt:message key="cars.info.engine"/> ${car.engine}</p>
                <p><fmt:message key="cars.info.acceleration"/> ${car.acceleration}</p> 
        ...
        <section class="textarea">
            <h2><b>${car.brand} ${car.model} <fmt:message key="cars.info.text.rental"/></b></h2>
            <p>${car.discription}</p>
        </section>
        <h2 class="textarea"><b><fmt:message key="cars.info.text.comments"/></b></h2>
        <div class = "comments">
