...
<body>    
  <header class="header">
    <a href="index.jsp"> <img class="logo"
        src="https://www.freelancejob.ru/upload/139/29eb6b9055a15d9a3aaca113ce12f81b.png" alt="logo" />
    </a>
    <nav>
      ...
      <section class="info">
        <div class="text" id="text-id">
	      ...
	      <form action="MainController" method="GET">
	          ...
	          <p style="text-align: center">Cost: ${penalty.costOfPenalty} $
	          <c:if test="${penalty.isClosed == false}">
	          	<p style="collor: red; text-align: center">NOT CLOSED</p>
	          </c:if>
	          <c:if test="${penalty.isClosed == true}">
	          	<p style="collor: green; text-align: center">CLOSED</p>
	          </c:if>
  ...
  <footer>
    <section class="contacts" id="contacts">
      <section>
        <a href="#"><img class="logo" src="https://www.freelancejob.ru/upload/139/29eb6b9055a15d9a3aaca113ce12f81b.png"
            alt="logo" />
        </a>
      </section>
      <div class="cont">
